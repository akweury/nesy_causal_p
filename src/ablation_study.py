...
def run_ablation_train_val(train_data, val_data, test_data, obj_model, group_model, train_principle, args, mode_name,
    ...
    hard, soft, group_nums, obj_list, group_list = training.ground_facts(
        train_data, obj_model, group_model, hyp_params, train_principle, args.device, ablation_flags, obj_times)
    val_hard, val_soft, val_group_nums, val_obj_list, val_group_list = training.ground_facts(val_data, obj_model,
