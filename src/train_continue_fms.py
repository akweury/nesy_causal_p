...
#         transforms.ToTensor(),
#     ])
#     continue_shape_dataset = dataset.ContinueShapeDataset(args, transform=transform)
#     train_size = int(0.8 * len(continue_shape_dataset))
#     val_size = len(continue_shape_dataset) - train_size
#     train_dataset, val_dataset = random_split(continue_shape_dataset, [train_size, val_size])
#
